...
Public Class rptReceiptLogo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BankersClub.rptReceiptLogo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReceiptLogo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReceiptLogo = New rptReceiptLogo()
        rpt.Site = Me.Site
        Return rpt
    End Function
