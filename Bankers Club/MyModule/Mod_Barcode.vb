Module Mod_Barcode
    Function Code128(ByVal TheText As String, ByVal CodeLetter As String) As Image
        ...
        ' CodeLetter Special variable category to be used

        Dim Binaryz As String = "" 'Will carry a variable text after converting to Beinery
        Dim I As Integer
        Dim NumCode As Integer 'Variable value will carry supplementary text account
        ...
        If CodeLetter = "C" Or CodeLetter = "c" Then
            ...
            Binaryz = "00101100011"
        End If
        ' CODE next character will be entrusting the value Balbeinery by private CODE table 128
        ...
        ' CODE next to see the character you want to add text to complete
        Select Case NumCode
            Case 0
                Binaryz = Binaryz & "00100110011"
            Case 1
            ...
            Case 102
                Binaryz = Binaryz & "00001010001"
        End Select
        Binaryz = Binaryz & "0011100010100" ' End code to add your Albainery stop all codes


        ' Create an image displayed number lettering Albainery user
        Dim bmp As Bitmap = New Bitmap(Len(Binaryz), 40, System.Drawing.Imaging.PixelFormat.Format24bppRgb)
        Dim z As String ' Variable to see the font color 
        Dim GraphZ As Graphics = Graphics.FromImage(bmp)
        Dim RectZ As Rectangle = New Rectangle(0, 0, bmp.Width, bmp.Height) ' A rectangle the size of the image to give a background in white
        ' Brush to paint the previous rectangle painted white
        ...
        ' The previous rectangle painted in white
        GraphZ.FillRectangle(myBrush, RectZ)
        '  Drawing barcode lines
        Dim PenZ As Pen
        Dim point1 As Point ' Beginning point font
        Dim point2 As Point ' End of the line point
        ...
        '' Text to be encoded draw down CODE
